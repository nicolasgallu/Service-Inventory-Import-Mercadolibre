...
def get_required_attributes(category_id, token):
    ...
    try:
        ...
        logger.info(f"Dynamic required attributes (filtered): {[a['id'] for a in required_attrs]}")
...
###/////////////////////PUBLISH EVENT///////////////////////////###
def publish_item(item_data, brand, description, public_images, token):
    ...
    item_format = {
        ...
        "attributes": [
            ...
            {"id": "EMPTY_GTIN_REASON", "value_id": "17055160"},  # No tiene código
    ...
    ####TRYING TO PUBLISH SECOND TIME####
        ...
        logger.info(f"item data fix: {item_data_fix}")
...
###/////////////////////UPDATE EVENT///////////////////////////###
def update_item(item_data, description, public_images, token):
